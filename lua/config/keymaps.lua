...
-- ============================================================
-- (19) LEFT-DOCKED NEO-TREE for <leader>e
-- ============================================================
-- Docked as a real split on the left, not a floating popup.
map("n", "<leader>e", "<cmd>Neotree position=left toggle reveal<CR>",
  { desc = "Explorer (left sidebar)" })
